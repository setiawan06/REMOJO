...
<html lang="zxx" class="no-js">
	...
	<body>
			...
			<div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="about-content col-lg-12">
						...
						<p class="text-white link-nav"><a href="<?php echo base_url() ?>index.php/home">Beranda </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?php echo base_url() ?>index.php/about"> Tentang Kami</a></p>
					</div>											
				</div>
			</div>
		</section>
		...
		<script type="<?php echo base_url();?>assets/users/text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
