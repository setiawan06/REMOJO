			...
			<div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="about-content col-lg-12">
						...
						<p class="text-white link-nav"><a href="<?php echo base_url() ?>index.php/home">Beranda </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?php echo base_url() ?>index.php/blog"> Berita</a></p>
					</div>											
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-lg-8 post-list blog-post-list">
						<div class="single-post">
							<img class="img-fluid" src="<?php echo base_url();?>assets/users/img/blog/p1.jpg" alt="">
							<ul class="tags">
								<li><a href="#">Art, </a></li>
						...
						<div class="single-post">
							<img class="img-fluid" src="<?php echo base_url();?>assets/users/img/blog/p2.jpg" alt="">
							<ul class="tags">
								<li><a href="#">Art, </a></li>
								<li><a href="#">Technology, </a></li>
								<li><a href="#">Fashion</a></li>
						...
						<div class="single-post">
							<img class="img-fluid" src="<?php echo base_url();?>assets/users/img/blog/p3.jpg" alt="">
							<ul class="tags">
								<li><a href="#">Art, </a></li>
								<li><a href="#">Technology, </a></li>
								<li><a href="#">Fashion</a></li>
						...
						<div class="single-post">
							<img class="img-fluid" src="<?php echo base_url();?>assets/users/img/blog/p4.jpg" alt="">
							<ul class="tags">
								<li><a href="#">Art, </a></li>
								<li><a href="#">Technology, </a></li>
								<li><a href="#">Fashion</a></li>
					...
					<div class="col-lg-4 sidebar">
						...
						<div class="single-widget protfolio-widget">
							<img src="<?php echo base_url();?>assets/users/img/blog/user2.jpg" alt="">
							...
							<div class="blog-list ">
								<div class="single-recent-post d-flex flex-row">
									<div class="recent-thumb">
										<img class="img-fluid" src="<?php echo base_url();?>assets/users/img/blog/r1.jpg" alt="">
									</div>
								...
								<div class="single-recent-post d-flex flex-row">
									<div class="recent-thumb">
										<img class="img-fluid" src="<?php echo base_url();?>assets/users/img/blog/r2.jpg" alt="">
									</div>
									<div class="recent-details">
										<a href="blog-single.html">
											<h4>
								...
								<div class="single-recent-post d-flex flex-row">
									<div class="recent-thumb">
										<img class="img-fluid" src="<?php echo base_url();?>assets/users/img/blog/r3.jpg" alt="">
									</div>
									<div class="recent-details">
										<a href="blog-single.html">
											<h4>
								...
								<div class="single-recent-post d-flex flex-row">
									<div class="recent-thumb">
										<img class="img-fluid" src="<?php echo base_url();?>assets/users/img/blog/r4.jpg" alt="">
									</div>
									<div class="recent-details">
										<a href="blog-single.html">
											<h4>
